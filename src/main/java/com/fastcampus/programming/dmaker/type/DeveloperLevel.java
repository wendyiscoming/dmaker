...
public enum DeveloperLevel {
    ...
    JUNIOR("주니어 개발자", years -> years <= MAX_JUINOR_EXPERIENCE_YEARS),
    JUNGNIOR("중니어 개발자", years -> years > MAX_JUINOR_EXPERIENCE_YEARS
            && years < MIN_SEINOR_EXPERIENCE_YEARS),
    SENIOR("시니어 개발자", years -> years >= MIN_SEINOR_EXPERIENCE_YEARS);
